        ...
        private async Task SendResponse(ITurnContext<IMessageActivity> turnContext, string input, string? callId, CancellationToken cancellationToken)
        {
            switch (input)
            {
                ...
                case "joinscheduledmeeting":
                    ...
                    if (channelData != null && channelData["meeting"] != null)
                    {
                    ...
                    break;
                default:
                    var channelData_default = turnContext.Activity.ChannelData as JObject;
                    await turnContext.SendActivityAsync(
                        MessageFactory.Attachment(
                            adaptiveCardFactory.CreateWelcomeCard(channelData_default != null && channelData_default["meeting"] != null)), cancellationToken);
                    break;
            }
        }
